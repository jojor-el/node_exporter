...
fonction_verif_bin_nodexp_exist() {
        ...
        then
                ...
                do
                        ...
                        echo "Il doit être supprimé pour continuer l'installation de Node Exporter"
                        echo "Souhaitez-vous le supprimer ? [yes/no]"
                        echo "si \" no \" est sélectionné, cela annulera l'installation de node exporter"
                        read -p "Reponse : " QUESTION_11
                done
                case $QUESTION_11 in
                        "yes" )
                                echo "le fichier bin sera suprimé"
